...
const testimonials = [
  {
    testimonial:
      "I thought it was impossible to make a website as beautiful as our product, but Tatenda proved me wrong.",
    name: "Sara Lee",
    designation: "CFO",
    company: "Acme Co",
  ...
  {
    testimonial:
      "I've never met a software developer who truly cares about their clients' success like Tatenda does.",
    name: "Thomas Andrews",
    designation: "COO",
    company: "DEF Corp",
  ...
  {
    testimonial:
      "After Tatenda optimized our website, our traffic increased by 50%. We can't thank them enough!",
    name: "Lisa Wang",
    designation: "CTO",
